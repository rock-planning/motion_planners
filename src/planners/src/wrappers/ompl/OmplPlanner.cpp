...
namespace motion_planners
{
    ...
    bool OmplPlanner::setUpPlanningTaskInCartesianSpace(PlannerStatus &planner_status)
    {
        ...
        lower_limits_["z"] = -5.0;
        upper_limits_["z"] = 5.0;
        lower_limits_["roll"] = -3.145;
        upper_limits_["roll"] = 3.145;
        lower_limits_["pitch"] = -3.145;
        upper_limits_["pitch"] = 3.145;
        lower_limits_["yaw"] = -3.145;
        upper_limits_["yaw"] = 3.145;
    ...
    void OmplPlanner::setPlannerStatus(const ompl::base::PlannerStatus::StatusType &ompl_status, motion_planners::PlannerStatus &planner_status)
    {
        ...
        case ompl::base::PlannerStatus::PlannerStatus::INVALID_START:
            planner_status.statuscode = motion_planners::PlannerStatus::INVALID_START_STATE;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::INVALID_GOAL:
            planner_status.statuscode = motion_planners::PlannerStatus::INVALID_GOAL_STATE;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::UNRECOGNIZED_GOAL_TYPE:
            planner_status.statuscode = motion_planners::PlannerStatus::UNRECOGNIZED_GOAL_TYPE;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::TIMEOUT:
            planner_status.statuscode = motion_planners::PlannerStatus::TIMEOUT;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::APPROXIMATE_SOLUTION:
            planner_status.statuscode = motion_planners::PlannerStatus::APPROXIMATE_SOLUTION;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::EXACT_SOLUTION:
            planner_status.statuscode = motion_planners::PlannerStatus::EXACT_SOLUTION;
            break;
        case ompl::base::PlannerStatus::PlannerStatus::CRASH:
            planner_status.statuscode = motion_planners::PlannerStatus::CRASH;
            break;
        default:
        {
