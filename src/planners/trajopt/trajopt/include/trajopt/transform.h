...
namespace trajopt
{
    ...
    namespace geometry
    {
        ...
        public:
            ...
            template <typename U>
            RaveVector(const RaveVector<U> &vec) : x((T)vec.x), y((T)vec.y), z((T)vec.z), w((T)vec.w)
            {
            }
            ...
            // SCALAR FUNCTIONS
            template <typename U>
            inline T dot(const RaveVector<U> &v) const
            {
                return x * v.x + y * v.y + z * v.z + w * v.w;
            }
            template <typename U>
            inline T dot3(const RaveVector<U> &v) const
            {
            ...
            template <typename U>
            inline RaveVector<T> &operator+=(const RaveVector<U> &r)
            {
                x += T(r.x);
                y += T(r.y);
                z += T(r.z);
            ...
            template <typename U>
            friend RaveVector<U> operator*(float f, const RaveVector<U> &v);
            template <typename U>
            friend RaveVector<U> operator*(double f, const RaveVector<U> &v);

            template <typename U>
            friend std::ostream &operator<<(std::ostream &O, const RaveVector<U> &v);
            template <typename U>
            friend std::istream &operator>>(std::istream &I, RaveVector<U> &v);

            /// cross product operator
            template <typename U>
            inline RaveVector<T> operator^(const RaveVector<U> &v) const
            {
                RaveVector<T> ucrossv;
                ucrossv[0] = y * v[2] - z * v[1];
                ucrossv[1] = z * v[0] - x * v[2];
        ...
        public:
            ...
            template <typename U>
            RaveTransform(const RaveVector<U> &rot, const RaveVector<U> &trans) : rot(rot), trans(trans)
            {
                MATH_ASSERT(rot.lengthsqr4() > 0.99f && rot.lengthsqr4() < 1.01f);
            }
            ...
            template <typename U>
            inline RaveTransform<T> &operator=(const RaveTransform<U> &r)
            {
                trans = r.trans;
                rot = r.rot;
                MATH_ASSERT(rot.lengthsqr4() > 0.99f && rot.lengthsqr4() < 1.01f);
            ...
            template <typename U>
            friend std::istream &operator>>(std::istream &I, RaveTransform<U> &v);
        ...
        public:
            ...
            template <typename U>
            friend std::istream &operator>>(std::istream &I, RaveTransformMatrix<U> &v);
        ...
        template <typename T>
        inline RaveVector<T> quatFromAxisAngle(const RaveVector<T> &axis, T angle)
        {
        ...
        template <typename T>
        inline RaveVector<T> quatFromAxisAngle(const RaveVector<T> &axisangle)
        {
        ...
        template <typename T>
        inline RaveVector<T> quatFromMatrix(const RaveTransformMatrix<T> &rotation)
        {
            RaveVector<T> rot;
        ...
        template <typename T>
        inline RaveTransformMatrix<T> matrixFromQuat(const RaveVector<T> &quat)
        {
        ...
        inline RaveVector<T> InterpolateQuatSlerp(const RaveVector<T> &quat0, const RaveVector<T> &quat1, T t, bool forceshortarc = true)
        {
            ...
            if (MATH_FABS(sinHalfTheta) < 1e-7f)
