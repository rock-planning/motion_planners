...
public:
  SingleTimestepCollisionEvaluator(ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars);
  /**
...
public:
  CastCollisionEvaluator(ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars0, const VarVector& vars1);
  void CalcDistExpressions(const DblVec& x, vector<AffExpr>& exprs);
  void CalcDists(const DblVec& x, DblVec& exprs);
  void CalcCollisions(const DblVec& x, vector<Collision>& collisions);
...
public:
  ...
  CollisionCost(double dist_pen, double coeff, ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars);
  /* constructor for cast cost */
  CollisionCost(double dist_pen, double coeff, ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars0, const VarVector& vars1);
...
public:
  /* constructor for single timestep */
  CollisionConstraint(double dist_pen, double coeff, ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars);
  /* constructor for cast cost */
  CollisionConstraint(double dist_pen, double coeff, ConfigurationPtr rad, CollisionCheckerPtr coll, const VarVector& vars0, const VarVector& vars1);
