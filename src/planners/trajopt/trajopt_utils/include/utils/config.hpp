...
namespace util
{
  ...
  struct ParameterVec : ParameterBase
  {
    ...
    ParameterVec(std::string name, std::vector<T> *value, std::string desc) : ParameterBase(name, desc),
                                                                              m_value(value) {}
  ...
  {
    T *m_value;
    Parameter(std::string name, T *value, std::string desc) : ParameterBase(name, desc),
                                                              m_value(value) {}
    void addToBoost(po::options_description &od)
    {
